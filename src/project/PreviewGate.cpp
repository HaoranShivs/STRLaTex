...
const char* ToString(PreviewGateDecision decision) {
    switch (decision) {
    case PreviewGateDecision::Accept:
        return "Accept";
    case PreviewGateDecision::NoProject:
        return "NoProject";
    case PreviewGateDecision::ForeignProject:
        return "ForeignProject";
    case PreviewGateDecision::StaleRevision:
        return "StaleRevision";
    case PreviewGateDecision::StaleSnapshot:
        return "StaleSnapshot";
    case PreviewGateDecision::StaleBuild:
        return "StaleBuild";
    }
    return "?";
}
...
PreviewGateDecision EvaluatePreviewGate(const PreviewGateInput& current, const BuildResult& result) {
    if (!current.has_project)
        return PreviewGateDecision::NoProject;
    ...
    if (!current.snapshot_id.empty() && result.snapshot_id != current.snapshot_id) {
