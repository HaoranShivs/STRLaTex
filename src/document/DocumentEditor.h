...
public:
  ...
  // Single- vs double-column figure. The value is stored unconditionally and
  // only takes visible effect in a two-column template (the renderer emits
  // the starred float for DoubleColumn).
